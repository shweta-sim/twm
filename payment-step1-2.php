          ...
          <div class="col-md-6 mb60-md wow fadeInUp" data-wow-delay="400ms">
            ...
            <div class="mb30">
              <form action="payment-step1-3.php" method="POST" name="" id="">
                ...
                <div class="form-group mb10">
                  <button class="btn btn-primary-bordered" type="submit" id="btnCreateAccount" name="btnCreateAccount">Create Account</button>
                </div>
                <div class="text-sm"><i>By clicking "Create account", you agree to TW + RL<br>
                  <a href="#">Terms Of Service</a> and <a href="#">Privacy Policy</a>.</i></div>
              </form>
            </div>
...
$(document).ready(function() {
  ...
  $('form[id="formCreateAccount"]').validate({
    rules: {
      name: 'required',
      email: {
        required: true,
    ...
    messages: {
      ...
      password: 'This field is password',
    },
