              ...
              <div class="col-md-5">
                <div class="booking-bl-info left">
                  ...
                  <h6 class="mb30">Friday 20th September 2021<br>
                    01.00PM - 01.30PM</h6>
                  <div class="text-md"><a href="book-call-step1.php">< Change date and time</a></div>
                </div>
              </div>
              <div class="col-md-7">
                <div class="booking-bl-info right">
                  <h2 class="mb20">Enter Details</h2>
                  <form action="book-call-step3.php" method="POST" name="" id="">
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <textarea name="yourmessage" id="yourmessage" class="form-control" placeholder="Please share anything that will help prepare for our meeting"></textarea>
                    </div>
                    <button class="btn btn-primary-bordered" type="submit" id="btnContact" name="btnContact">Book the call</button>
                  </form>
                </div>
              </div>
            </div>
