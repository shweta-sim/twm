    ...
    <div class="container">
      <div class="row mb40">
        <div class="col-12 text-center">
          <h2 class="heading text-center wow fadeInUp" data-wow-delay="200ms">Recover Your Password
            <hr>
          </h2>
        </div>
      </div>
          ...
          <div class="mb20">
            <form action="" method="POST" name="formLogin" id="formLogin">
              <div class="form-group mb10">
                Enter your email address and we'll send you a link to reset your password along with instructions.<br><br>
              ...
              <div class="form-group d-flex align-items-center">
                ...
                <div class="ml-auto"><a href="login.php" class="text-bold">Back to login</a></div>
              </div>
            </form>
          </div>
        </div>
