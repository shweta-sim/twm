...
<section class="featured-brands">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2
              class="heading text-center mb30 wow wow2 fadeInUp"
    ...
    <div class="row d-flex align-items-center">
      <div
            class="col-12 col-lg-4 col-xl text-center mb20-lg wow wow2 fadeInUp"
            data-wow-delay="400ms"
          > <img
              src="assets/imgs/brand-logo4.png"
              class="img-fluid"
              alt="Tag Heuer"
            /> </div>
      <div
          ...
          > <img
              src="assets/imgs/brand-logo1.png"
              class="img-fluid"
              alt="Selfridges&Co"
            /> </div>
      <div
          ...
          > <img
              src="assets/imgs/brand-logo2.png"
              class="img-fluid"
              alt="Easy Jet"
            /> </div>
      <div
            class="col-12 col-lg-4 offset-lg-2 col-xl offset-xl-0 text-center mb20-sm wow wow2 fadeInUp"
            data-wow-delay="1000ms"
          > <img
              src="assets/imgs/brand-logo3.png"
              class="img-fluid"
              alt="LVMH"
            /> </div>
      <div
            class="col-12 col-lg-4 col-xl text-center wow wow2 fadeInUp"
            data-wow-delay="1200ms"
          > <img
              src="assets/imgs/brand-logo5.png"
              class="img-fluid"
              alt="Bulgari"
            /> </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb40-md">
        <div
              class="benefit-bl text-center wow wow2 fadeInUp"
              data-wow-delay="400ms"
            >
          <div class="mb20"> <img
                  src="assets/imgs/img-benefit1.svg"
                  class="img-fluid"
                  alt="Dedicated Teams"
                /> </div>
      ...
      <div class="col-md-4 mb40-md">
        <div
            ...
            >
          <div class="mb20"> <img
                  src="assets/imgs/img-benefit2.svg"
                  class="img-fluid"
                  alt="Dedicated Teams"
                /> </div>
      ...
      <div class="col-md-4">
        <div
            ...
            >
          <div class="mb20"> <img
                  src="assets/imgs/img-benefit3.svg"
                  class="img-fluid"
                  alt="Dedicated Teams"
                /> </div>
...
<section class="testimonials">
  <div class="container">
    <div class="row mb80">
      <div class="col-12">
        <h2
              class="heading text-center mb10 wow wow2 fadeInUp"
              data-wow-delay="200ms"
...
seen our productivity increase by 60%.</p>
            ...
            <div class="swiper-slide testimonial-pHenchTalk">
              <div class="row align-items-center">
                <div
                      class="col-md-6 col-lg-5 offset-lg-1 col-xl-5 offset-xl-2 mb20-md wow wow2 fadeInLeft"
                      data-wow-delay="400ms"
                    > <img
                        src="assets/imgs/testimonial_1-design.jpg"
                        class="img-fluid img"
                        alt=""
                      /> </div>
                <div
                  ...
                  <div class="swiper-text">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="img mr-3"> <img
                              src="assets/imgs/testimonial1-client.jpg"
                              class="img-fluid"
                              alt=""
                            /> </div>
                      <i class="text-sm"
            ...
            <div class="swiper-slide testimonial-pSummitTea">
              <div class="row align-items-center">
                <div
                      ...
                      data-wow-delay="400ms"
                    > <img
                        src="assets/imgs/testimonial_2-design.jpg"
                        class="img-fluid img"
                        alt=""
                      /> </div>
                <div
                  ...
                  <div class="swiper-text">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="img mr-3"> <img
                              src="assets/imgs/testimonial2-client.jpg"
                              class="img-fluid"
                              alt=""
                            /> </div>
                      <i class="text-sm"
