        ...
        <div class="row">
          ...
          <div class="col-md-7 col-lg-8">
            <div class="content-bl wow fadeInLeft" data-wow-delay="300ms">
              <div class="d-flex">
                <h5 class="mb20">Subscription Detail</h5>
                <div class="ml-auto"><a href="account-subscriptions.php">< Back</a></div>
              </div>
              <ul class="subscriptions-list mb20">
                <li>
                  <div class="row">
              ...
              <div class="mb40"> <a href="" class="btn btn-primary-bordered mr-2 mb10-sm">Change</a><a href="" class="btn btn-primary-bordered mr-2 mb10-sm">Cancel</a><a href="contact.php" class="btn btn-primary-bordered mb10-sm">Contact</a></div>
              <div class="mb40">
                <div class="row mb10-sm">
                  <div class="col-12 col-sm-4">Cost</div>
                  <div class="col-12 col-sm-8">$389.99</div>
                </div>
                <div class="row mb10-sm">
                  <div class="col-12 col-sm-4">Payment method</div>
                  <div class="col-12 col-sm-8">Mastercard xxxx xxxx xxxx 8976</div>
                </div>
                <div class="row">
                  <div class="col-12 col-sm-4">Next invoice</div>
                  <div class="col-12 col-sm-8">June 17, 2022</div>
                </div>
              </div>
              <h5 class="mb20">Renewal history</h5>
              <ul class="renewal-history">
                <li>
                  <div>June 16, 2021 <a href="" class="text-primary">Download invoice</a></div>
                  <div>
                  $389.99 [Mastercard xxxx xxxx xxxx 8976] </li>
                <li>
                  <div>June 16, 2020 <a href="" class="text-primary">Download invoice</a></div>
                  <div>
                  $389.99 [Mastercard xxxx xxxx xxxx 8976] </li>
                <li>
                  <div>June 16, 2019 <a href="" class="text-primary">Download invoice</a></div>
                  <div>
                  $389.99 [Mastercard xxxx xxxx xxxx 8976] </li>
                <li>
                  <div>June 16, 2018 <a href="" class="text-primary">Download invoice</a></div>
                  <div>
                  $389.99 [Mastercard xxxx xxxx xxxx 8976] </li>
              </ul>
            </div>
