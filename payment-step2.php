      ...
      <div class="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
        ...
        <div class="row step2">
          <div class="col-md-6 wow fadeInUp" data-wow-delay="400ms">
            <h2 class="heading text-left mb20">Payment Details
              <hr>
            </h2>
            <form action="" method="POST" name="formBookCall" id="formBookCall">
              <div class="form-group mb10">
                <div class="card-details d-flex">
                  <input type="text" name="cardnumber" id="cardnumber" class="form-control" placeholder="Card number*"><input type="text" name="datemonth" id="datemonth" class="form-control form-control-sm" placeholder="MM/YY"><input type="text" name="cvc" id="cvc" class="form-control form-control-sm" placeholder="CVC">
                </div>
              </div>
              <div class="form-group mb10">
                <input type="text" name="cardholdername" id="cardholdername" class="form-control" placeholder="Cardholder's name*">
              </div>
              <div class="form-group mb10">
              ...
              <div class="form-group mb10">
                <select type="select" name="country" id="country" class="form-control required">
              ...
              <div class="form-group">
                <label class="custom-checkbox">
                  ...
                  <div class="text-sm"><i>I understand and agree with TW + RL <a href="terms.php">terms of service</a>.</i></div>
                </label>                
                 </div>
                <a class="btn btn-primary-bordered d-inline-flex" href="payment-step3.php"><i class="mr-2"><img src="assets/imgs/icon-lock.svg" class="svg"></i>Finish & pay</a>
            </form>
          </div>
          <div class="col-md-5 offset-md-1 order-first order-md-last mb30-sm wow fadeInUp" data-wow-delay="400ms">            
            <h6 class="mb20">Hi Oliver,<br>
              Here are the details of your plan</h6>
            <div>Your plan:</div>
            <div class="d-flex mb20">
              <h6>I need a logo</h6>
              <div class="ml-auto"><a href="plans.php">Change plan</a></div>
            </div>
            <div class="mb20">What's included:</div>
            <ul class="plan-features">
              <li>Vestibulum non diam volutpat, luctus orci a, accumsan purus.</li>
              <li>Nam congue volutpat mi id ullamcorper.</li>
              <li>Etiam convallis nisi vitae magna</li>
            </ul>
            <hr class="divider">
            <h6 class="d-flex">
              <div>Total</div>
              <div class="ml-auto">£239</div>
            </h6>
          </div>
        </div>
      </div>
